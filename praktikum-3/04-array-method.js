...
// forEach untuk menampilkan semua produk
console.log("\nDaftar produk:");
produk.forEach((item) => {
  if (item.stok > 0) {
    console.log(
      `[TERSEDIA] ${item.nama} - Rp${item.harga.toLocaleString()} (${item.stok} unit)`,
    );
  } else {
